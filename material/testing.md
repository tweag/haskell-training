...
Unit tests are great, but they help us only with cases we thought about, they do not help us to discover cases we were not expecting.

To address this, the [`QuickCheck`](https://hackage.haskell.org/package/QuickCheck) library was developed in the Haskell ecosystem.

It enables to write property based tests, i.e. asserting that a property holds for basically any combination of the involved values.
